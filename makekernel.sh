...
MODULES_DIR=${HOME}/kernel/pure/cwm/system/lib/modules
KERNEL_DIR=`pwd`
OUTPUT_DIR=${HOME}/kernel/pure
CWM_DIR=${HOME}/kernel/pure/cwm
ZIMAGE_DIR=${HOME}/github/kernel/pure/arch/arm/boot
CWM_MOVE=${HOME}/kernel/pure
BOOT_IMG=${HOME}/kernel/pure/boot
ZIMAGE_ANYKERNEL=${HOME}/kernel/pure/cwm
ANYKERNEL_DIR=${HOME}/kernel/pure
